package com.schoolcopilot.content_service.web.client;
...
import com.schoolcopilot.content_service.web.client.dto.EducationLevelView;
import com.schoolcopilot.content_service.web.client.dto.EducationSystemView;
import com.schoolcopilot.content_service.web.client.dto.SubjectView;
import com.schoolcopilot.content_service.web.client.dto.TrackView;
...
public class ReferenceController {
     ...
     * choisit sa classe, et y lit {@code hasTracks} pour savoir s'il faudra lui
     * demander une filiere.
     */
    ...
    public EducationLevelView level(@PathVariable String systemCode,
        ...
        return EducationLevelView.of(reference.requireSelectableLevel(systemCode, levelCode));
    }
