...
/**
 * Toutes les erreurs sortent au format {@code application/problem+json}, avec un
 * champ {@code code} stable que les applications clientes peuvent tester sans
 * jamais avoir a lire le message.
 */
...
public class GlobalExceptionHandler {
    ...
    ProblemDetail handleAuthException(AuthException exception) {
        ...
        problem.setTitle("Echec de l'authentification");
    ...
    ProblemDetail handleUnexpected(Exception exception) {
        // Le detail technique reste dans les logs : le renvoyer au client
        // reviendrait a documenter le serveur pour un attaquant.
