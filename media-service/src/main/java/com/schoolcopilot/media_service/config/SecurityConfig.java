...
import com.schoolcopilot.media_service.config.Role;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtDecoder jwtDecoder,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Le transfert des octets se fait sur adresse pre-signee,
                        // sans jeton : c'est tout l'interet du procede. La
                        // protection vient de la signature et de son expiration,
                        // verifiees par le controleur.
                        .requestMatchers("/api/v1/media/blob/**").permitAll()
