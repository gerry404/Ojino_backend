...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtDecoder jwtDecoder,
            CorsProperties corsProperties, SupportProperties supportProperties) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers("/api/v1/admin/**").hasRole(Role.ADMIN);

                    if (supportProperties.faq().publicAccess()) {
                        auth.requestMatchers("/api/v1/faq/**").permitAll();
                    }
